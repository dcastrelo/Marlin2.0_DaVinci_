...
* Recv: echo: M92 X80.00 Y80.00 Z2560.00 E837.00
...
* Recv: echo:  M304 P366.68 I64.77 D1383.86
* Recv: echo:Z-Probe Offset (mm):
* Recv: echo:  M851 X-28.00 Y0.00 Z-0.7
...
#define STRING_CONFIG_H_AUTHOR "Dcastrelo" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "DaVinci?"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 366.68
  #define DEFAULT_bedKi 64.77
  #define DEFAULT_bedKd 1383.86
...
//no me dio bola!!! lo solucione con un M851 X28
...
// Travel limits (mm) after homing, corresponding to endstop positions. LA CAMA TIENE 160X202 Y EL OFFSET DE x ES DE 17 Y EL DE Y 3
#define X_MIN_POS 0
#define Y_MIN_POS 0
#define Z_MIN_POS 0
...
#define Z_SAFE_HOMING
  ...
  //#define Z_SAFE_HOMING_X_POINT (((X_BED_SIZE) / 2)+17)    // X point for Z homing when homing all axes (G28).
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 1), (Y_MAX_POS - 1), 20 }
